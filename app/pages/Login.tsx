             ...
             <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Find new series on {providerShortLabel(Providers.AsuraScans)}, {providerShortLabel(Providers.MangaFire)}, {providerShortLabel(Providers.MangaGG)}, or AniList instantly with one search bar.
                  </p>
                </div>
             </div>
          </div>
